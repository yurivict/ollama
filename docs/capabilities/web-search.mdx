...
More Ollama [Python example](https://github.com/yurivict/ollama-python/blob/main/examples/web-search.py)
...
More Ollama [JavaScript example](https://github.com/yurivict/ollama-js/blob/main/examples/websearch/websearch-tools.ts)
...
```json
{
  ...
  "links": [
    ...
    "https://github.com/yurivict/ollama"
  ]
...
models](https://ollama.com/models)\n\nAvailable for macOS, Windows, and Linux',
    links=['https://ollama.com/', 'https://ollama.com/models', 'https://github.com/yurivict/ollama']
)
```
...
You can enable web search in any MCP client through the [Python MCP server](https://github.com/yurivict/ollama-python/blob/main/examples/web-search-mcp.py).
