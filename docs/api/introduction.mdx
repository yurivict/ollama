...
Several community-maintained libraries are available for Ollama. For a full list, see the [Ollama GitHub repository](https://github.com/yurivict/ollama?tab=readme-ov-file#libraries-1).
