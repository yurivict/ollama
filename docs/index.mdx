...
<CardGroup cols={2}>
  ...
  <Card title="Python library" icon="python" href="https://github.com/yurivict/ollama-python">
    Use Ollama from Python.
  </Card>

  <Card title="JavaScript library" icon="js" href="https://github.com/yurivict/ollama-js">
