...
<CardGroup cols={2}>
  <Card
    ...
    icon="python"
    href="https://github.com/yurivict/ollama-python"
  >
    The official library for using Ollama with Python
  </Card>

  <Card title="Ollama's JavaScript library" icon="js" href="https://github.com/yurivict/ollama-js">
    The official library for using Ollama with JavaScript or TypeScript.
  </Card>
  <Card title="Community libraries" icon="github" href="https://github.com/yurivict/ollama?tab=readme-ov-file#libraries-1">
