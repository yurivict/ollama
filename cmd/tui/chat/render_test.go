...
func TestChatStreamingRendersBoldBareURLAfterCompletion(t *testing.T) {
	const response = "Draft PR opened: **https://github.com/yurivict/ollama/pull/17203**"
	...
	if !strings.Contains(plain, "Draft PR opened: https://github.com/yurivict/ollama/pull/17203") {
		t.Fatalf("rendered response missing URL: %q", plain)
	}
	if !strings.Contains(rendered, chatStrongStyle.Render("https://github.com/yurivict/ollama/pull/17203")) {
